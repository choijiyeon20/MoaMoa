...
public class mainhomemypage extends Fragment {
    private View view;

    //네비바 외의 프레그먼트와 연결할 때 꼭 필요한 newlnstnce() 메소드
    public static mainhomemypage newlnstnce(){
        return new mainhomemypage();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton button = (ImageButton) view.findViewById(R.id.mine);
